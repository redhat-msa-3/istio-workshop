...
Look at `istio-tutorial/customer/src/main/java/com/example/customer/tracing/HttpHeaderForwarderHandlerInterceptor.java`{{open}}

and 

`istio-tutorial/customer/src/main/java/com/example/customer/CustomerApplication.java`{{open}} on lines 21 to 31.
