...
Open `/recommendation/src/main/java/com/redhat/developer/demos/recommendation/RecommendationController.java`{{open}} in the editor. Now make the following modification.
